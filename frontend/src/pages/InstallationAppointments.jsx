                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {(appointment.status === "PENDING" || appointment.status === "SCHEDULED") && (
                        <Button
                          ...
                          className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 shadow-lg hover:scale-105 transition-transform"
                        >
            ...
            <CardContent className="pt-6 space-y-6 max-h-[70vh] overflow-y-auto">
                    ...
                    <div key={index} className="p-4 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        {completionData.equipment_installed.length > 1 && (
                          <Button onClick={() => removeCamera(index)} variant="ghost" size="sm" className="text-red-600 hover:bg-red-50 hover:scale-110 transition-transform">
              ...
              <div className="flex gap-3 pt-4 border-t-2">
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 shadow-lg hover:scale-105 transition-transform"
